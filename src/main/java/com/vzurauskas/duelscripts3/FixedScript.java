...
public final class FixedScript implements CombatScript {
    private BiFunction<Fighter, Fighter, BodyPart> parrySelector = (self, opponent) -> self.torso();
    private BiFunction<Fighter, Fighter, BodyPart> strikeSelector = (self, opponent) -> opponent.torso();
    ...
    public FixedScript strike(Function<Fighter, BodyPart> opponentSelector) {
        this.strikeSelector = (self, opponent) -> opponentSelector.apply(opponent);
        return this;
    }
